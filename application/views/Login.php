                        ...
                        <div class="col-md-6">
                            <div id="contact" class="contact">
                                ...
                                <div class="container">
                                    <div class="row">
                                        <div class="col-md-12 ">
                                            <form class="main_form" action="<?= base_url() ?>login/autenticar" method="post" enctype="multipart/form-data">
                                                <div class="row">
                                                    <div class="col-md-12 ">
                                                    ...
                                                    <div class="col-sm-12">
                                                        ...
                                                        <a href="<?= base_url() ?>login/registar"  style="text-align: center;" class="send_btn">Registar</a>
                                                    </div>
                                                </div>
                                            </form>
                                        </div>
